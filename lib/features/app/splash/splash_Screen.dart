...
import 'package:whatapp_clone/features/app/welcome/welcome.dart';
    ...
    return Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            Column(
              children: [
                Text("from", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: greyColor.withValues(alpha:0.6)),),
